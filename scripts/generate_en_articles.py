...
1. Open {zh_url} and pick the protocol your users actually use (usually HTTPS).
...
TOPIC_HINTS: list[tuple[str, str]] = [
    (r"dns", "Focus on TTL, recursive vs authoritative DNS, and GeoDNS. Compare multiple public resolvers if provinces disagree."),
