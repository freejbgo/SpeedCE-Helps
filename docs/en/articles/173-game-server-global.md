---
title: "Game Server: Dual China + Global Reachability Checks"
keywords: game,server,speed test,SpeedCE,multi-node
...
# Game Server: Dual China + Global Reachability Checks
