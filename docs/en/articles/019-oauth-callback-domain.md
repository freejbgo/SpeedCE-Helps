---
title: "OAUTH Callback Domain: Symptoms, Scope, and Fixes with Multi-Node Testing"
keywords: oauth,callback,domain,speed test,SpeedCE,multi-node
...
# OAUTH Callback Domain: Symptoms, Scope, and Fixes with Multi-Node Testing
...
Test callback and API hostnames independently. Main-site green plus API red is a common release mistake.
