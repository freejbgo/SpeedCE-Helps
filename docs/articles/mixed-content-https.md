...
category: 故障排查
description: "本文围绕「混合内容与 HTTPS」展开，提供可落地的技术方案，并在验收环节说明如何用 SpeedCE 多节点测速确认效果。"
keywords: 混合内容,HTTPS,SpeedCE
...
- 排查「混合内容与 HTTPS」时，建议按「影响面 → 层级 → 修复 → 复测」四步走，不要跳步。
