...
category: 方法论
description: "本文围绕「网络拨测与 PageSpeed 分工」展开，提供可落地的技术方案，并在验收环节说明如何用 SpeedCE 多节点测速确认效果。"
keywords: PageSpeed,网络测速,SpeedCE
...
- 围绕「网络拨测与 PageSpeed 分工」，上线或变更后用多节点测速验收。
- 三网分离，不要只看平均延迟。
- 对照测是排障第一原则。
- 修完必复测，截图必存档。
